...
[^2a_details]: This will take a while. It will also be how you start ProxSpace to use your Proxmark after you've completed the setup. When we're using ProxSpace, we're using Bash which the terminal (or command prompt) commonly used in Linux. If you want to learn more about using Bash, [go here](https://www.freecodecamp.org/news/linux-command-line-bash-tutorial/).
[^2b_details]: TODO
